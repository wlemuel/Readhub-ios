...
let kThemePrimaryColor = kColor(light: UIColor.hexColor(0x007AFF), dark: UIColor.hexColor(0xD54C3B))
let kThemeSecondaryColor = kColor(light: UIColor.hexColor(0x0066FF), dark: UIColor.hexColor(0xC47432))
